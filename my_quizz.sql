...
--
-- Hôte : localhost:3306
-- Généré le : lun. 09 mai 2022 à 16:55
...
('DoctrineMigrations\\Version20220507160301', '2022-05-07 18:03:35', 681);
...
CREATE TABLE `log_user` (
  ...
  `log_connexion` datetime DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `log_user` (`id`, `log_user_id`, `log_connexion`) VALUES
(1, 6, '2022-05-09 14:30:55'),
(2, 1, '2022-05-09 14:31:07'),
(3, 1, '2022-05-09 14:58:03'),
(4, 1, '2022-05-09 16:02:14'),
(5, 2, '2022-05-09 16:05:00'),
(6, 1, '2022-05-09 16:06:44'),
(7, 1, '2022-05-09 16:26:22'),
(8, 1, '2022-05-09 16:26:29'),
(9, 1, '2022-05-09 16:47:56');
...
INSERT INTO `question` (`id`, `categorie_id`, `question`) VALUES
...
INSERT INTO `reponse` (`id`, `question_id`, `reponse`, `reponse_expected`) VALUES
(1, 1, 'Un fou', 1),
(2, 1, 'Une tour', 0),
(3, 1, 'Un pion', 0),
(4, 2, 'Sorbet Citron', 1),
...
(1, 'admin@admin.com', '{\"0\": \"ROLE_ADMIN\", \"1\": \"ROLE_USER\"}', '$2y$13$NWn4mn8wFJogb00F3e1fne1UztXbdQ6JsJvoTDDGFtz5cMPVHiQfa', 1),
(2, 'random@random.fr', '[\"ROLE_USER\"]', '$2y$13$.gPl.wuZeZM5290PCTafW.P68W69.LWHJQorHY.rIsxcXhRMPnv2m', 0),
(6, 'random@random.com', '[]', '$2y$13$bFRkmtyYBKOCZTYx8sizBu2EigJfCu0/rHrhhtGEHYbw.eFoZ.CYK', 0);
...
ALTER TABLE `log_user`
  ADD PRIMARY KEY (`id`),
  ADD KEY `IDX_9CFD383C9FA3EB02` (`log_user_id`);
...
ALTER TABLE `question`
  ADD PRIMARY KEY (`id`),
  ADD KEY `IDX_B6F7494EBCF5E72D` (`categorie_id`);
...
ALTER TABLE `reponse`
  ADD PRIMARY KEY (`id`),
  ADD KEY `IDX_5FB6DEC71E27F6BF` (`question_id`) USING BTREE;
...
--
ALTER TABLE `log_user`
  ADD CONSTRAINT `FK_9CFD383C9FA3EB02` FOREIGN KEY (`log_user_id`) REFERENCES `user` (`id`);

--
-- Contraintes pour la table `question`
--
ALTER TABLE `question`
  ADD CONSTRAINT `FK_B6F7494EBCF5E72D` FOREIGN KEY (`categorie_id`) REFERENCES `categorie` (`id`);
