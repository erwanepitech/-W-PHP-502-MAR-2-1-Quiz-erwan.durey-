...
class __TwigTemplate_edf585f342b310d78bc1e032178c9907 extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    events: [ ";
            // line 161
            echo twig_call_macro($macros["__internal_parse_3"], "macro_dump_events", [(isset($context["events"]) || array_key_exists("events", $context) ? $context["events"] : (function () { throw new RuntimeError('Variable "events" does not exist.', 161, $this->source); })())], 161, $context, $this->getSourceContext());
            echo " ],
}
";
...
{% endmacro %}
", "@WebProfiler/Collector/time.html.twig", "/home/erwan/formation/semestre 2/projet/W-PHP-502-MAR-2-1-Quiz-erwan.durey/Quiz/vendor/symfony/web-profiler-bundle/Resources/views/Collector/time.html.twig");
    }
}
